...
public class NhapThongTinBaoDuong extends BaseActivity {
    HoleData holeData;
    TextView tvtentuyen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(NhapThongTinBaoDuong.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(NhapThongTinBaoDuong.this, new String[]
                    {android.Manifest.permission.READ_EXTERNAL_STORAGE}, 100);
            return;
        }
        if (ActivityCompat.checkSelfPermission(NhapThongTinBaoDuong.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(NhapThongTinBaoDuong.this, new String[]
                    {android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, 100);
            return;
        }
        setContentView(R.layout.activity_nhap_thong_tin_bao_duong);
        initView();
        ...
        btnLuu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (common.coAnh(imgPhotoBd) == true) {
                    android.app.AlertDialog.Builder b = new android.app.AlertDialog.Builder(NhapThongTinBaoDuong.this);
                    b.setTitle("Cảnh báo");
                    ...
                    android.app.AlertDialog.Builder b = new android.app.AlertDialog.Builder(NhapThongTinBaoDuong.this);
                    b.setTitle("Cảnh báo");
                    b.setMessage("Chụp ảnh trước khi truyền về?");
                    b.setPositiveButton("ĐỒNG Ý", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.cancel();
        ...
        gps = new GPSTrack(NhapThongTinBaoDuong.this);
        ...
        btnvitri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NhapThongTinBaoDuong.this, MapActivity.class);
                //Create the bundle
        ...
        BarcodeReaderApiManager.getInstance().accountApi().updateToaDo(Hole_ID,request).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response.isSuccessful()){
                    try {
                        if(null !=response.body()){
                            ...
                            if(result.equals("true")){
                                Toast.makeText(NhapThongTinBaoDuong.this, "Cập nhật tọa độ thành công!", Toast.LENGTH_LONG).show();

                            }else {
                                Toast.makeText(NhapThongTinBaoDuong.this, "Lỗi cập nhật tọa độ!", Toast.LENGTH_LONG).show();
                            }
                        }else {
                            Toast.makeText(NhapThongTinBaoDuong.this, "Lỗi cập nhật tọa độ!", Toast.LENGTH_LONG).show();
                        }
                    ...
                    Toast.makeText(NhapThongTinBaoDuong.this, "Sai tên đăng nhập hoặc mật khẩu cũ!", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(NhapThongTinBaoDuong.this, "Lỗi cập nhật", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onBackPressed() {
        if (isConnected()) {
            ...
            Intent intent = new Intent(NhapThongTinBaoDuong.this, TabActivityBaoDuong.class);
            startActivity(intent);
        } else {
            Toast.makeText(NhapThongTinBaoDuong.this, "Chưa kết nối internet", Toast.LENGTH_LONG).show();
        }
