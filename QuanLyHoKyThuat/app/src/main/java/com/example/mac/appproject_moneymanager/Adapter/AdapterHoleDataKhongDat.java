...
public class AdapterHoleDataKhongDat extends BaseAdapter {
    ...
    public AdapterHoleDataKhongDat(Activity a, ArrayList<HoleData> d) {
        this.mActivity = a;
        this.lstholedata = d;
        stt = 0;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            vi = mInflater.inflate(R.layout.item_tab3_column, viewGroup, false);
            vi.requestFocus();
        ...
        try {
            if (lstholedata.size() <= 0) {
                ...
                if(tempValue.Maintain_Status >0){
