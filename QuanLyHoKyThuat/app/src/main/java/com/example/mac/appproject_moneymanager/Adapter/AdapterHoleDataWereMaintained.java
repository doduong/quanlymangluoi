...
public class AdapterHoleDataWereMaintained extends BaseAdapter {
    ...
    public AdapterHoleDataWereMaintained(Activity a, ArrayList<HoleData> d) {
        this.mActivity = a;
        this.lstholedata = d;
        stt = 0;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            vi = mInflater.inflate(R.layout.layout_adapter_holedata_were_maintained, viewGroup, false);
            vi.requestFocus();
